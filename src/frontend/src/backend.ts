...
import type { Place as _Place, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getEnrollmentsByAcademy(arg0: string): Promise<Array<Enrollment>> {
        if (this.processError) {
            try {
    ...
    async getPlaceById(arg0: PlaceId): Promise<Place | null> {
        if (this.processError) {
            try {
    ...
    async getPlacesBySport(arg0: string): Promise<Array<Place>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlacesBySport(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializePlaces(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializePlaces();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitEnrollment(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string): Promise<EnrollmentId> {
        if (this.processError) {
            try {
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Place]): Place | null {
    return value.length === 0 ? null : value[0];
}
